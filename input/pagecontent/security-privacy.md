...
- **Zugriff/AuthN/AuthZ:** modulspezifisch; in der MII über die jeweilige
  Infrastruktur geregelt. `TODO:REVIEW`
- **De-Identifikation/Pseudonymisierung:** sofern für Sekundärnutzung relevant,
  hier referenzieren. `TODO:REVIEW`
- **Einwilligung/Consent:** Verweis auf das einschlägige Consent-Modul, sofern
  zutreffend. `TODO:REVIEW`
