...
Stream **„MII-Kerndatensatz" → Topic „Releases"** ([mii.zulipchat.com](https://mii.zulipchat.com/)).
...
- Automatisierung: der `RELEASE`-Job in [`.github/workflows/main.yml`](.github/workflows/main.yml) erstellt bei
...
Für werkzeuggestützte Pipelines: der in [`PUBLISHING.md`](PUBLISHING.md) §2 beschriebene
...
- **HL7-Deutschland-Newsletter/Mailingliste** für offizielle Verfahren
  (Ankündigung von Kommentierungs-/Ballotierungsphasen, vgl. [`COMMENT_RESOLUTION.md`](COMMENT_RESOLUTION.md)).
