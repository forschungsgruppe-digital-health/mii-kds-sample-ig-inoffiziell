...
|--------|-----|---------------|--------|
| HL7 FHIR R4 (4.0.1) | https://hl7.org/fhir/R4/ | `sushi-config.yaml` (fhirVersion) | [S] |
| FHIR ImplementationGuide-Ressource | https://hl7.org/fhir/implementationguide.html | `ig.ini`, IG-Resource | [S] |
| FHIR IG Publisher | https://github.com/HL7/fhir-ig-publisher | `_genonce.sh`, `_updatePublisher.sh`, Workflows | [V] |
| FSH / SUSHI | https://github.com/FHIR/sushi · https://fshschool.org | `input/fsh/*`, Build | [V] |
| GoFSH (FHIR→FSH) | https://github.com/FHIR/GoFSH | `MIGRATION.md` (A2/Phase 2) | [S] |
...
| Quelle | URL | Angewendet in | Status |
|--------|-----|---------------|--------|
| HL7 Europe Base/Core IG v2.0.0 | https://hl7.eu/fhir/base · https://build.fhir.org/ig/hl7-eu/base/ | optionale Dependency, `context.md` | [V]/[O] |
...
| Quelle | URL | Angewendet in | Status |
|--------|-----|---------------|--------|
| Basisprofile DE (`de.basisprofil.r4` 1.5.4) | https://ig.fhir.de/basisprofile-de/ | `sushi-config.yaml` Dependency | [V] |
| HL7 Deutschland (GitHub) | https://github.com/hl7germany | Profil-Dependency, Beispiele | [V] |
| HL7 DE Ballotportal / Kommentierung | https://ballots.hl7.de · https://hl7.de | `CONTRIBUTING.md` | [D] |
| HL7 DE Abstimmungs-/Kommentierungsregeln (PDF) | https://hl7.de/wp-content/uploads/Abstimmungsregeln-20221213.pdf | `COMMENT_RESOLUTION.md`, Issue-Templates | [V] |
| HL7 DE Ballotierungsportal (Service Desk) | https://portal.hl7.de · https://hl7germany.atlassian.net/servicedesk | `.github/ISSUE_TEMPLATE/config.yml` | [V] |

## 5. MII-Kerndatensatz (Governance & Vorgaben)
| Quelle | URL/Beleg | Angewendet in | Status |
|--------|-----------|---------------|--------|
| KDS-Governance (jeweils gültige Fassung) | MII-intern / MII-Meta-Wiki | Sprache, Versionierung, `CONTRIBUTING.md`, Review-Gates | [D] |
...
| Meta-Manteldokument (jeweils aktuelle Fassung) | https://simplifier.net/guide/mii-ig-modul-template-2025?version=current | Crosswalk, `input/pagecontent/*` | [V] |
...
| Wiki: Namenskonventionen FHIR-Ressourcen | …/wiki/Namenskonventionen-für-FHIR‐Ressourcen-in-der-MII | `qc/custom.rules.yaml`, `AGENTS.md` | [V] |
| Wiki: Terminology Version Policy | …/wiki/Terminology-Version-Policy | `TERMINOLOGY.md`, `sushi-config.yaml` | [V] |
| Wiki: GitHub Reusable Validation Workflows | …/wiki/GitHub-Reusable-Validation-Workflows | `.github/workflows/main.yml`, `advisor.json` | [V] |
| Wiki: Dev Container ‐ IG Publisher | …/wiki/Dev-Container-‐-IG-Publisher | `.devcontainer/devcontainer.json` | [V] |
| Wiki: Module Release Workflow | …/wiki/Module-Release-Workflow | `main.yml` (RELEASE), Versionierung | [V] |
| MII Zulip (Releases) | https://mii.zulipchat.com | `NOTIFICATIONS.md`, `main.yml` (NOTIFY_ZULIP) | [V] |
...
| MII-Kerndatensatz (Website) | https://www.medizininformatik-initiative.de/de/der-kerndatensatz-der-medizininformatik-initiative | `references.md` | [S] |
